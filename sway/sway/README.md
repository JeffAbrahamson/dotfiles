...
* [`i3status.conf`](i3status.conf), [`kitty.conf`](kitty.conf), [`mako-config`](mako-config), [`swaylock_config`](swaylock_config), and [`systemd-mako-service`](systemd-mako-service) configure surrounding desktop components.
