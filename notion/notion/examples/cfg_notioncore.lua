-- Example by Johannes Schöön <schoon@mail.dk>
...
defbindings("WScreen", {
    ...
    bdoc("Landscape"),
    kpress(ALTMETA.."F10", "ioncore.exec_on(_, 'xrandr -o normal')"),
    
    bdoc("Portrait"),
    kpress(ALTMETA.."F11", "ioncore.exec_on(_, 'xrandr -o left')"),
...
--         "mod_query.query_editfile(_, 'run-mailcap --action=edit')"),
    kpress(ALTMETA.."F5", 
           "mod_query.query_editfile(_, ':nvi')"),

    bdoc("Query for file to view."),
--  kpress(ALTMETA.."F6", 
--         "mod_query.query_runfile(_, 'run-mailcap --action=view')"),
    kpress(ALTMETA.."F6", 
           "mod_query.query_runfile(_, ':nview')"),
